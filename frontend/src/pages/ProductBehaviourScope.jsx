...
const FAQS = [
  {
    ...
    a: "No. BehaviourScope™ is an AI-guided western-astrology lens designed to spark reflection, not diagnose. For clinical concerns, please consult a qualified child psychologist or paediatrician.",
  },
  {
    q: "How accurate are the readings?",
    a: "Each reading is generated by Claude Sonnet 4.5 from your child's name, place and birth-date/time, combined with classical western-astrology sun-sign archetypes. Parents report it feels 'surprisingly aligned' but it is interpretive guidance, not a deterministic test.",
  },
  {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-x-8 gap-y-3 text-xs text-indigo-200/80">
              <span className="flex items-center gap-1.5"><CheckCircle2 size={14} className="text-emerald-400" strokeWidth={2.5} /> AI-powered (Claude Sonnet 4.5)</span>
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <Card className="rounded-3xl p-8 bg-white border-slate-100" data-testid="pricing-free">
            ...
            <ul className="space-y-3 text-sm text-slate-700 mb-8">
              ...
              <li className="flex items-start gap-2"><CheckCircle2 size={16} className="text-emerald-500 mt-0.5 flex-shrink-0" strokeWidth={2.5} /> AI book / link / activity recommendations</li>
