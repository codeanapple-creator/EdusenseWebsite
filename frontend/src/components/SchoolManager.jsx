...
const PLAN_STYLES = {
  ...
  pro: { bg: "bg-gradient-to-br from-amber-100 to-yellow-100", text: "text-orange-700", border: "border-orange-200" },
};
...
export default function SchoolManager() {
    ...
    return (
      <Card className="rounded-3xl p-7 bg-white border-slate-100" data-testid="school-empty-card">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <div className="text-xs uppercase tracking-widest font-bold text-[#0a1f5c] mb-1">Get started</div>
          ...
          <Dialog open={openCreate} onOpenChange={setOpenCreate}>
            <DialogTrigger asChild>
              <Button className="rounded-full bg-[#f97316] hover:bg-[#ea580c] font-bold btn-lift" data-testid="create-school-btn">
            ...
            <DialogContent>
              ...
              <form onSubmit={create} className="space-y-3">
                ...
                <DialogFooter>
                  <Button type="submit" disabled={creating} className="rounded-full bg-[#f97316] hover:bg-[#ea580c] font-bold" data-testid="school-save-btn">
  ...
  return (
    <Card className="rounded-3xl p-7 bg-white border-slate-100" data-testid="school-card">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <button onClick={copyCode} className="inline-flex items-center gap-1.5 text-xs font-bold rounded-full bg-orange-100 hover:bg-amber-200 text-orange-700 border border-orange-200 px-2.5 py-1" data-testid="school-code-btn">
              ...
              {inGrace && <Badge className="rounded-full bg-orange-100 text-amber-800 border-amber-300 font-bold">Grace period</Badge>}
      ...
      {plan === "pro" && (
        <div className="mt-4 rounded-2xl border border-orange-200 bg-white/60 p-3 text-xs text-amber-800 flex items-start gap-2" data-testid="mock-notice">
